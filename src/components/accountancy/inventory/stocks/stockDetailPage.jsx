...
import InventoryService from '@/services/sales'
...
const StockDetailPage = routerData => {
  ...
  useEffect(() => {
    if (quoteId) {
      ...
      const fetchData = async () => {
        const result = await InventoryService.getStockById(quoteId, 'post')
  ...
  const approveInvoice = () => {
    ...
    const fetchData = async () => {
      const result = await InventoryService.approveInvoice(data, 'post')
      // console.log(result, 'result')
  ...
  const menu = (
    <Menu>
      ...
      <Menu.Item>
        <Link to={`/inventory/stocks/edit/${quoteId}`}>Edit</Link>
      </Menu.Item>
      <Menu.Item>
        <a target="_blank" rel="noopener noreferrer">
          Delete
...
export default connect()(StockDetailPage)
