...
class CreateProject extends React.Component {
  ...
  onFinish = values => {
    ...
    // console.log('dataSource 123', dataSource)
  ...
  handleChange = (e, record) => {
    // console.log(record, 'handleChange', e.target.value)
    const { dataSource } = this.state
    let amount = 0
    let total = 0
    let subTotal = 0
      ...
      <>
        ...
        <Form layout="vertical" onFinish={this.onFinish} onFinishFailed={this.onFinishFailed}>
          <div className="row">
            ...
            <div className="col-md-12">Budget</div>
            <div className="col-md-4">
              <Form.Item name="costBudget" label="Cost Budget">
                <LoadCon itemsData={itemsData} handleShowHide={this.handleShowHide} />
              </Form.Item>
            </div>
            <div className="col-md-4">
              <Form.Item name="revenueBudget" label="Revenue Budget">
                <LoadCon itemsData={itemsData} handleShowHide={this.handleShowHide} />
              </Form.Item>
            </div>
            <div className="col-md-12">Users</div>
            ...
            <div className="col-md-12">Tasks</div>
