      ...
      <>
        <Row className="mt-2 marginZero">
          ...
          {type === 'liabilities' && balType !== 'horizontal' && (
            <>
              <Col span={20} className="text-end tableCSS">
                <strong>Net Profit</strong>
              </Col>
              <Col span={4} className="text-end tableCSS">
            ...
            <Row className="account-row">
              {Object.keys(accounts[item]).map(ele => {
                ...
                return (
                  <>
                    <Col
                      span={24}
                      className="account-heading tableCSS"
                      // style={{ borderBottom: '1px solid #ccc' }}
                    >
                      <strong>{ele}</strong>
                    </Col>
                    <Col span={24} className="tableCSS p-0">
                        ...
                        return (
                          <Row className="ps-0">
                            ...
                            {accounts[item][ele][element].map(val => {
                              return (
                                <Col span={24} className="p-0 tableCSS" key={val}>
                                  <Row className="p-0">
                                    <Col span={20} className="tableCSS1">
                                      {val.accountName}
                                    </Col>
                                    <Col span={4} className="text-end tableCSS1">
                                      <Link
                                        to={{
                            ...
                            <Col span={20} className="account-heading tableCSS">
                              {/* {console.log(accounts?.[item]?.[ele], ele)} */}
                              <strong> Total for {element} </strong>
                            </Col>
                            <Col span={4} className="account-heading text-end tableCSS">
              ...
              {type === 'assets' && item === 'type 1' && (
                <>
                  <Col
                    span={20}
                    className="pt-2 pb-2 ps-2 mt-3 tableCSS text-end"
                  ...
                  <Col
                    span={4}
                    className="text-end pt-2 pb-2 mt-3 tableCSS"
        ...
        <div className="report__content ">
          <Row className="balancesheet-section mb-3">
            ...
            <Col span={balType === 'horizontal' ? 12 : 24} className="left-section">
              ...
              <Row>
                <Col span={24} className="right-body-section p-0">
