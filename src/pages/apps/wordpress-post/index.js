            ...
            <div className="card-body">
              ...
              <div>
                <img
                  ...
                  src="/assets/resources/images/content/photos/1.jpeg"
                  alt="Sea"
                />
                <p>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center flex-wrap border-bottom mb-3 pb-3">
                <div className="kit__utils__avatar kit__utils__avatar--size110 me-3 mb-3 align-items-center flex-shrink-0">
              ...
              <Form className="login-form">
                ...
                <Form.Item>
                  <Button className="me-2" type="primary" style={{ width: 200 }}>
