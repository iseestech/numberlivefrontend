    ...
    <div>
      ...
      <div className="d-flex flex-xs-wrap border-bottom pb-4 mb-4">
        <div className="me-auto pe-3">
          ...
          <div className="mb-3">
            <span className="me-3 text-uppercase badge badge-success">Open</span>
        ...
        <div className="col-lg-9">
          <div className="d-flex align-items-start mb-3">
            <a
              href="#"
              onClick={e => e.preventDefault()}
              className="kit__utils__avatar kit__utils__avatar--size50 me-3 flex-shrink-0"
            >
              <img src="/assets/resources/images/avatars/5.jpg" alt="Mary Stanform" />
            </a>
          ...
          <div className="d-flex align-items-start mb-3">
            <a
              ...
              className="kit__utils__avatar kit__utils__avatar--size50 me-3 flex-shrink-0"
            >
              <img src="/assets/resources/images/avatars/4.jpg" alt="Mary Stanform" />
            </a>
            <div className="card flex-grow-1">
              ...
              <div className="card-body border-top py-2 px-3">
                <a
                  href="#"
                  onClick={e => e.preventDefault()}
                  className="btn btn-success btn-with-addon text-nowrap ms-3 my-3"
                >
          ...
          <div className="py-4">
            ...
            <div className="kit__utils__avatarGroup mb-3">
              <div className="kit__utils__avatar kit__utils__avatar--size46">
                <img src="/assets/resources/images/avatars/1.jpg" alt="User 1" />
              </div>
              <div className="kit__utils__avatar kit__utils__avatar--size46">
                <img src="/assets/resources/images/avatars/2.jpg" alt="User 2" />
              </div>
              <div className="kit__utils__avatar kit__utils__avatar--size46">
                <img src="/assets/resources/images/avatars/3.jpg" alt="User 3" />
              </div>
              <div className="kit__utils__avatar kit__utils__avatar--size46">
                <img src="/assets/resources/images/avatars/4.jpg" alt="User 4" />
              </div>
            </div>
          </div>
        </div>
