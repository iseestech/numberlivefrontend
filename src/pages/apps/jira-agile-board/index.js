  ...
  const [backlogItems, setBacklogItems] = useState([
    <div className={style.card} key={1}>
      <div className={style.content}>
        ...
        <div className="d-flex flex-wrap-reverse align-items-center">
          <h5 className="text-dark font-size-18 mt-2 me-auto">Backend Issue</h5>
        ...
        <div className="d-flex align-items-center flex-wrap pb-2">
          <div className="kit__utils__avatar kit__utils__avatar--rounded kit__utils__avatar--size27 flex-shrink-0 me-2">
            <img src="/assets/resources/images/avatars/2.jpg" alt="User" />
          </div>
    ...
    <div className={style.card} key={2}>
      <div className={style.content}>
        ...
        <div className="d-flex flex-wrap-reverse align-items-center">
          <h5 className="text-dark font-size-18 mt-2 me-auto">Prepare Activity List</h5>
          <i className="fe fe-arrow-left-circle text-success font-size-30 flex-shrink-0" />
        </div>
        <div className="text-gray-5 mb-2">Deadline 7:00</div>
        <div className="d-flex align-items-center flex-wrap pb-2">
          <div className="kit__utils__avatar kit__utils__avatar--rounded kit__utils__avatar--size27 flex-shrink-0 me-2">
            <img src="/assets/resources/images/avatars/1.jpg" alt="User" />
          </div>
          <div className="text-gray-5">
            <del>AWS-200</del>
          </div>
  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-center mb-4">
        <div className="kit__utils__avatarGroup me-4 flex-shrink-0">
        ...
        <a className="me-4" href="#" onClick={e => e.preventDefault()}>
          Only My Issues
        </a>
