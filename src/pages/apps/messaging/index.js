          ...
          <div className={style.dialogs}>
            <PerfectScrollbar>
              {dialogs.map((item, index) => (
                ...
                >
                  <div className="kit__utils__avatar kit__utils__avatar--size46 me-3 flex-shrink-0">
          ...
          <div className="card">
            <div className="card-header card-header-flex align-items-center">
              <div className="d-flex flex-column justify-content-center me-auto">
                <h5 className="mb-0 me-2 font-size-18">
                        ...
                        <div className={`${style.messageAvatar} kit__utils__avatar`}>
                          <img
                            src={`${
                              message.owner !== 'you'
                                ? avatar
                                : '/assets/resources/images/avatars/avatar-2.png'
                            }`}
                            alt={name}
                          />
                        </div>
