  ...
  return (
    <div>
      ...
      <div className="d-flex flex-wrap align-items-center">
        <div className="kit__utils__avatar kit__utils__avatar--size64 flex-shrink-0 me-5 mb-3">
          <img src="/assets/resources/images/avatars/2.jpg" alt="Mary Stanform" />
        </div>
        <div className="me-auto mb-3">
          <div className="text-dark font-weight-bold font-size-24">
            <span className="me-3">Mediatec Software</span>
      ...
      <div className="mb-5">
        <div className="card mb-3">
          <div className="card-body py-2">
            <div className="d-flex align-items-center flex-wrap">
              <div className="d-flex flex-nowrap align-items-center width-200 flex-shrink-1 me-2">
                <div className="kit__utils__donut kit__utils__donut--danger me-2 flex-shrink-0" />
                <a
                  href="#"
                  onClick={e => e.preventDefault()}
              ...
              <div className="flex-grow-1 me-2">FRA1 / 1GB / 25GB Disk</div>
              <div className="flex-grow-1 me-auto">46.101.103.230</div>
        ...
        <div className="card mb-3">
          <div className="card-body py-2">
            <div className="d-flex align-items-center flex-wrap">
              <div className="d-flex flex-nowrap align-items-center width-200 flex-shrink-1 me-2">
                <div className="kit__utils__donut kit__utils__donut--success me-2 flex-shrink-0" />
                <a
                  href="#"
                  onClick={e => e.preventDefault()}
                  className="font-weight-bold text-blue text-nowrap"
