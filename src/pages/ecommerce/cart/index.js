    ...
    },
    {
      ...
      render: () => (
        <a href="#" onClick={e => e.preventDefault()} className="btn btn-sm btn-light">
          <i className="fe fe-trash me-1" /> Remove
        </a>
      ),
      className: 'text-end',
    },
        ...
        <div className="card-body">
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-4">
              ...
              <h2>
                <i className="fa fa-cc-visa text-primary me-1" />
                <i className="fa fa-cc-mastercard text-default me-1" />
          ...
          <div className="border-top text-dark font-size-18 pt-4 text-end">
            <p className="mb-1">
