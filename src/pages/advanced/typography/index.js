  ...
  return (
    <div>
      ...
      <div className="kit__utils__heading">
        <h5>
          <span className="me-3">Typography</span>
          <a
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="mb-5">
                ...
                <h1>
                  <i className="fe fe-home me-3" aria-hidden="true" />
                  Bootstrap heading
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="mb-5">
                ...
                <ul className="list-unstyled">
                  <li>
                    <i className="fe fe-check me-2" aria-hidden="true" />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="mb-5">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a>
                      <i className="fe fe-check me-2" aria-hidden="false" />
                      Nulla volutpat aliquam velit
                    </a>
