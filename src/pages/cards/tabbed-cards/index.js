  ...
  return (
    <div>
      ...
      <div className="kit__utils__heading">
        <h5>
          <span className="me-3">Tabbed Cards</span>
          <a
          ...
          <div className="card">
            <div className="card-header card-header-flex">
              <div className="d-flex flex-row align-items-center me-auto">
                <h5 className="mb-0">
                  <i className="fe fe-activity me-1 font-size-18 text-muted" />
                  With Icon
                </h5>
              </div>
              <Tabs defaultActiveKey="1" className="kit-tabs-bold">
                <TabPane
                  tab={
                    <span>
                      <i className="fe fe-align-left me-1" />
                      Left
                    </span>
                  }
                  key="1"
                ...
                <TabPane
                  tab={
                    <span>
                      <i className="fe fe-align-center me-1" />
                      Center
                    </span>
                  }
                  key="2"
                ...
                <TabPane
                  tab={
                    <span>
                      <i className="fe fe-align-right me-1" />
                      Right
                    </span>
                  }
                  key="3"
