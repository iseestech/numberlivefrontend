  ...
  return (
    <div>
      ...
      <div className="kit__utils__heading">
        <h5>
          <span className="me-3">Basic Cards</span>
          <a
      ...
      <div className="row">
            ...
            <div className="card-header card-header-flex">
              <div className="d-flex flex-column justify-content-center me-auto">
                <div className="d-flex flex-row justify-content-center">
                  <h5 className="mb-0 me-2">With Description</h5>
        ...
        <div className="col-xl-6 col-lg-12">
            ...
            <div className="card-header card-header-flex align-items-center">
              ...
              <div>
                <Tooltip placement="top" title="Unlock Account">
                  <a className="btn btn-sm btn-light me-2">
          ...
          <div className="card">
            ...
            <div className="card-footer">
              <a className="btn btn-primary me-2">Save</a>
              <a className="btn btn-link">Cancel</a>
            </div>
          </div>
          <div className="card">
              ...
              <div className="d-flex flex-column justify-content-center me-auto">
                <div className="d-flex flex-row justify-content-center">
                  <h5 className="mb-0 me-2">
                    <i className="fe fe-phone-call me-2 font-size-18 text-muted" />
                    With Icon
                  </h5>
                  <span className="text-muted">Some description here...</span>
                </div>
          ...
          <div className="card card-solid bg-success">
            <div className="card-header card-header-flex">
              <div className="d-flex flex-column justify-content-center me-auto">
                <div className="d-flex flex-row justify-content-center">
                  <h5 className="mb-0 me-2">Solid Card</h5>
                </div>
              </div>
            </div>
            <div className="card-body">
